...
Config_Port:	
    ...
    ;Config User Button	    ||Button de placa // Inicia la secuencia
    BANKSEL PORTA
    CLRF    PORTA,1	
    CLRF    ANSELA,1	
    BSF	    TRISA,3,1	
    ...
    ;Config Ext Button - RB4	|| Button RB4 Pausa
    BANKSEL PORTB
    CLRF    PORTB,1	
    CLRF    ANSELB,1	
    BSF	    TRISB,4,1	
    ...
    ;Config Ext Button - RF2	  || Button RF2 Reinicia del todo
    BANKSEL PORTF
    CLRF    PORTF,1	
    CLRF    ANSELF,1	
    BSF	    TRISF,2,1	
