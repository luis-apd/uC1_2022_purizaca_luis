...
FINAL_IMAGE=${DISTDIR}/Instruction.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Byte.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Byte.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Byte.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Byte.o
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Instruction.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F57Q84
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Instruction.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Byte.o: Byte.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Byte.o 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Instruction.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F57Q84 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Instruction.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
