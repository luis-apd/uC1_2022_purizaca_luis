...
SOURCEFILES_QUOTED_IF_SPACED=tablas.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/tablas.o
POSSIBLE_DEPFILES=${OBJECTDIR}/tablas.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/tablas.o

# Source Files
SOURCEFILES=tablas.s
...
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/ports.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/tablas.o: tablas.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/tablas.o 
	${MP_AS} -mcpu=PIC18F57Q84 -c \
	-o ${OBJECTDIR}/tablas.o \
	tablas.s \
...
${DISTDIR}/ports.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	-o ${DISTDIR}/ports.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
